...
from general_functions import collectStockName
...
#========================================================
def carSelect(filepath,car_column='CAR[-W:W]',t_column='CAR[-W:W] t-Score',car_criteria=0.2,t_criteria=1.96,days=21):
